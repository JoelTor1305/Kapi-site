  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 pt-4">
        <div className={`rounded-3xl transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] ${isScrolled
          ...
          <div className="relative flex items-center justify-center h-16 px-6">
            ...
            {/* Social Links & Language Switcher - Right */}
            <div className="absolute right-6 hidden md:flex items-center gap-3">
              ...
              {/* Language Switcher */}
              <div className="flex items-center gap-1 bg-charcoal-800/50 rounded-full p-1">
                <button
                  onClick={() => setLanguage('en')}
                  className={`px-2 py-1.5 rounded-full text-base transition-all duration-300 ${language === 'en'
                    ? 'bg-gold-500 scale-110'
                    : 'opacity-60 hover:opacity-100 hover:bg-charcoal-700/50'
                    }`}
                  title="English"
                >
                  🇺🇸
                ...
                <button
                  ...
                  className={`px-2 py-1.5 rounded-full text-base transition-all duration-300 ${language === 'pl'
                    ? 'bg-gold-500 scale-110'
                    : 'opacity-60 hover:opacity-100 hover:bg-charcoal-700/50'
                    }`}
                  title="Polski"
          ...
          {isOpen && (
            <div className="md:hidden mt-2">
              <div className="px-2 pt-2 pb-3 space-y-1 bg-charcoal-900/95 backdrop-blur-md rounded-2xl shadow-lg border border-charcoal-800">
                ...
                <div className="flex items-center justify-center gap-1 bg-charcoal-800/50 rounded-full p-1 mb-2 mx-2">
                  <button
                    onClick={() => setLanguage('en')}
                    className={`flex-1 px-3 py-2 rounded-full text-lg transition-all duration-300 ${language === 'en'
                  ...
                  <button
                    onClick={() => setLanguage('pl')}
                    className={`flex-1 px-3 py-2 rounded-full text-lg transition-all duration-300 ${language === 'pl'
                      ? 'bg-gold-500 scale-105'
                      : 'opacity-60 hover:opacity-100 hover:bg-charcoal-700/50'
                      }`}
                    title="Polski"
